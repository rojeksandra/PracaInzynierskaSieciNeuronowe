    ...
    if request.method == "POST":
        ...
        if file:
            ...
            try:
                ...
                return render_template('index.html', predicted_emotion=predicted_emotion, file_path=file_path)
            except Exception as e:
                error_message = f"Błąd przy przetwarzaniu pliku: {str(e)}"
                return render_template('index.html', error_message=error_message, file_path=file_path)
